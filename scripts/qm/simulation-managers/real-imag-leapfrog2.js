class Leapfrog2SimulationManager extends SimulationManager {
    ...
    step(params) {
        ...
        draw();
        unbind();
        swapFrames[t].useProgram(realImagTimeStepProgram);
        swapFrames[t].bind();
    ...
    initWavefunc(params, wavefuncParams) {
        ...
        draw();
        unbind();
        swapFrames[t-2].useProgram(realImagTimeStepProgram);
        swapFrames[t-2].bind();
