...
void main() {
    vec4 wavefunc0 = texture(texWavefunc0, UV);
    vec4 wavefunc1 = texture(texWavefunc1, UV);
    vec4 wavefunc2 = texture(texWavefunc2, UV);
    ...
    float potentialBrightness = texture(texPotential, UV).w
